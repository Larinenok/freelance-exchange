# Generated by Django 3.2.13 on 2023-03-30 02:28
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('stars_customer', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='stars_customer', to='users.star', verbose_name='Оценка заказчика')),
                ('stars_freelancer', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='stars_freelancer', to='users.star', verbose_name='Оценка исполнителя')),
                ('user_permissions', models.ManyToManyField(blank=True, help_text='Specific permissions for this user.', related_name='user_set', related_query_name='user', to='auth.Permission', verbose_name='user permissions')),
                ('views', models.ManyToManyField(blank=True, to='users.Ip', verbose_name='Просмотры профиля')),
            ],
            options={
